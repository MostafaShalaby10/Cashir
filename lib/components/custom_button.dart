...
Widget button({required context , required String text , required Color? color , required double minWidth , required double height ,required Function() function})
{
...
Widget calculatorNumber({required String number}){
  return Expanded(
    child: InkWell(
      onTap: (){},
      child: CircleAvatar(
...
Widget checkBoxItem({required Function(bool?) function , required String text , required bool value}) {
  return Row(
    children: [
      Checkbox(
        value: value,
